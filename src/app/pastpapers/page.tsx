...
import { FaGraduationCap, FaBook, FaCalendarAlt, FaEye, FaChevronDown, FaChevronUp } from 'react-icons/fa'
          ...
          {Object.entries(subjects).map(([year, semesters], yearIndex) => (
            <div key={year} className="space-y-4">
              ...
              {Object.entries(semesters).map(([semester, subjectList], semesterIndex) => (
                <div key={semester} className="bg-white shadow-md border border-gray-200">
                  <button
